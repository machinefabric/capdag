---
title: "Machine Notation"
layout: doc
permalink: /09-machine-notation/
---
# Machine Notation
...
This document describes the language. The dispatch and ranking semantics for individual caps are defined in [05-DISPATCH](/docs/07-dispatch) and [06-RANKING](/docs/08-ranking); machine notation builds on top of them.
