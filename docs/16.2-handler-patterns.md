...
let prompt = require_stream_str(&streams, "media:textable")?;
...
```rust
for media_urn in &["media:textable", "media:rst;textable", "media:log;textable", "media:md;textable"] {
...
fn require_text_content(streams: &[(String, Vec<u8>)]) -> Result<&[u8], StreamError> {
    for urn in &["media:textable", "media:rst;textable", "media:log;textable", "media:md;textable"] {
