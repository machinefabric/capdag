...
#[test]
fn test0055_plain_text_refines_bare_textable() {
    assert!(
...
#[test]
fn test0069_image_description_refines_plain_text() {
    assert!(
...
#[test]
fn test0070_disbind_page_refines_plain_text() {
    assert!(
...
#[test]
fn test0079_transcription_does_not_refine_plain_text() {
    assert!(
