...
#[test]
fn rich_max_tokens_does_not_equal_bare_max_tokens() {
    assert!(
...
#[test]
fn rich_max_tokens_conforms_to_bare_max_tokens() {
    assert!(
...
#[test]
fn all_rich_numeric_params_conform_to_their_bare_pattern() {
    let pairs: &[(&str, &str)] = &[
...
#[test]
fn every_textable_tagged_urn_conforms_to_bare_textable() {
...
#[test]
fn numeric_params_do_not_cross_match() {
...
#[test]
fn page_text_only_matches_textable_catch_all() {
...
#[test]
fn system_prompt_must_be_matched_before_textable_catch_all() {
    assert!(
...
#[test]
fn model_spec_does_not_conform_to_any_numeric_parameter() {
    assert!(!conforms(MODEL_SPEC_GGUF_LLM, BARE_MAX_TOKENS));
